...
Install development dependencies into `/node_modules`.

> Note: if you see console errors referring to the `medseek-config` library this indicates that you have a malformed `.npmrc` file. You should make sure that you haven't edited this file, and if need be replace your local copy with the [original content](https://gitlab.emdeon.net/react-ui/app-boilerplate/raw/develop/.npmrc).
